	...
	tests := []testcase{
		...
		},
		{
			...
			fields: fields{
				...
				opts: MakeOptions("./testing", "test"),
				src: newMockSource(
					func() func(ctx context.Context, prefix, filename string, r io.Reader) (string, error) {
						var count int
						return func(ctx context.Context, prefix, filename string, r io.Reader) (string, error) {
							count++
							if count < 2 {
								return filename, nil
							}
